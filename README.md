...
- 🎯 Entry points to execute your program using `python -m <ted_talk_video_downloader>` or `$ ted_talk_video_downloader` with basic CLI argument parsing.
...
```py
from ted_talk_video_downloader import BaseClass
from ted_talk_video_downloader import base_function
